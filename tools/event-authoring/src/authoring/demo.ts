...
export const createDemoProject = (): AuthoringProject => {
  ...
  const registries: GameRegistries = {
    ...
    locations: [{ id: 'starter_port', seaId: 'starter_sea', blocksScheduledEvents: false, allowsShipSale: true }, { id: 'east_blue_port', seaId: 'starter_sea', blocksScheduledEvents: false, allowsShipSale: true }, { id: 'west_blue_port', seaId: 'starter_sea', blocksScheduledEvents: false, allowsShipSale: true }, { id: 'north_blue_port', seaId: 'starter_sea', blocksScheduledEvents: false, allowsShipSale: true }, { id: 'south_blue_port', seaId: 'starter_sea', blocksScheduledEvents: false, allowsShipSale: true }, { id: 'open_sea', seaId: null, blocksScheduledEvents: false, allowsShipSale: false }, { id: 'isolated_cove', seaId: null, blocksScheduledEvents: true, allowsShipSale: false }],
