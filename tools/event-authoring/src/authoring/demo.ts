...
export const createDemoProject = (): AuthoringProject => {
  ...
  const registries: GameRegistries = {
    ...
    careerAffiliations: [{ id: 'civilian', nameKey: 'careerAffiliation.civilian.name' }], marineRanks: [], careerTitles: [], endings: [],
  ...
  return { authoringVersion: 10, gameSchemaVersion: CONTENT_SCHEMA_VERSION, name: 'OPFG Events Demo', sourceLocale: 'fr', supportedLocales: ['fr','en'], events, nodes: [
