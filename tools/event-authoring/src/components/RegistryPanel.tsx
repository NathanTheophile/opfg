...
import { affiliationNameKey, itemNameKey, npcNameKey, raceNameKey, seaNameKey, shipNameKey, traitDescriptionKey, traitNameKey } from '../localization/keys';
import { ensureKeys } from '../localization/store';
import { IdSelect, NumberInput } from './EditorPrimitives';
import LocalizedField from './LocalizedField';

type RegistryTab = 'races' | 'seas' | 'affiliations' | 'traits' | 'items' | 'ships' | 'npcs' | 'locations' | 'flags';
const TABS: RegistryTab[] = ['races','seas','affiliations','traits','items','ships','npcs','locations','flags'];
