...
export function createContentCatalog(events: EventDefinition[]): ContentCatalog {
  return {
    ...
    npcs: [
      ...
      { id: 'rohan', nameKey: npcNameKey('rohan'), sex: 'male', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian', crewRoleId: 'cook', initialStats: defaultNpcStats() },
      { id: 'ari', nameKey: npcNameKey('ari'), sex: 'female', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian', crewRoleId: 'medic', initialStats: defaultNpcStats() },
      { id: 'owen', nameKey: npcNameKey('owen'), sex: 'male', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian', crewRoleId: 'shipwright', initialStats: defaultNpcStats() },
