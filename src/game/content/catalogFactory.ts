...
export function createContentCatalog(events: EventDefinition[]): ContentCatalog {
  return {
    ...
    locations: [
      { id: 'east_blue_port', seaId: 'east_blue', blocksScheduledEvents: false, allowsShipSale: true },
      { id: 'west_blue_port', seaId: 'west_blue', blocksScheduledEvents: false, allowsShipSale: true },
      { id: 'north_blue_port', seaId: 'north_blue', blocksScheduledEvents: false, allowsShipSale: true },
      { id: 'south_blue_port', seaId: 'south_blue', blocksScheduledEvents: false, allowsShipSale: true },
      { id: 'starter_port', seaId: 'east_blue', blocksScheduledEvents: false, allowsShipSale: true },
      { id: 'open_sea', seaId: null, blocksScheduledEvents: false, allowsShipSale: false },
      { id: 'outer_route', seaId: null, blocksScheduledEvents: false, allowsShipSale: false },
      { id: 'isolated_cove', seaId: null, blocksScheduledEvents: true, allowsShipSale: false },
      { id: 'shipwreck_shore', seaId: null, blocksScheduledEvents: false, allowsShipSale: false },
    ],
    traits: [
