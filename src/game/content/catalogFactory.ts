...
export function createContentCatalog(events: EventDefinition[]): ContentCatalog {
  return {
    ...
    races: [
      { id: 'human', nameKey: raceNameKey('human'), playableV1: true, initialHealth: 40, attributeModifiers: { observation: 1, intelligence: 1, charisma: 1, luck: 1, morale: -2 } },
      { id: 'fishman', nameKey: raceNameKey('fishman'), playableV1: true, initialHealth: 50, attributeModifiers: { strength: 4, agility: 1, observation: 2, intelligence: -2, navigation: 3, charisma: -3, luck: -2, morale: -3 } },
      { id: 'mink', nameKey: raceNameKey('mink'), playableV1: true, initialHealth: 40, attributeModifiers: { strength: -1, agility: 4, observation: 4, intelligence: -2, navigation: -3, charisma: 1, luck: -2, morale: -1 } },
      ...
      { id: 'longarm', nameKey: raceNameKey('longarm'), playableV1: false, initialHealth: 45, attributeModifiers: { strength: 2, agility: 4, observation: 3, intelligence: 1, navigation: -3, charisma: -2, luck: -2, morale: -3 } },
      { id: 'buccaneer', nameKey: raceNameKey('buccaneer'), playableV1: false, initialHealth: 55, attributeModifiers: { strength: 4, agility: -3, observation: 1, intelligence: -1, navigation: -2, charisma: -1, luck: -2, morale: 4 } },
    ],
    ...
    crewRoles: [
      { id: 'navigator', nameKey: crewRoleNameKey('navigator'), annualPower: 'navigator' },
      { id: 'medic', nameKey: crewRoleNameKey('medic'), annualPower: 'medic' },
      { id: 'shipwright', nameKey: crewRoleNameKey('shipwright'), annualPower: 'shipwright' },
      { id: 'recruiter', nameKey: crewRoleNameKey('recruiter'), annualPower: 'recruiter' },
      { id: 'first_mate', nameKey: crewRoleNameKey('first_mate'), annualPower: 'first_mate' },
      { id: 'helmsman', nameKey: crewRoleNameKey('helmsman'), passive: { type: 'globalStats', statIds: ['navigation', 'luck'] } },
      { id: 'cook', nameKey: crewRoleNameKey('cook'), passive: { type: 'globalStats', statIds: ['strength', 'agility'] } },
      { id: 'musician', nameKey: crewRoleNameKey('musician'), passive: { type: 'globalStats', statIds: ['morale', 'charisma'] } },
      { id: 'scholar', nameKey: crewRoleNameKey('scholar'), passive: { type: 'globalStats', statIds: ['intelligence', 'observation'] } },
      { id: 'foreman', nameKey: crewRoleNameKey('foreman'), passive: { type: 'annualIncome' } },
    ],
    npcs: [
      { id: 'mira', nameKey: npcNameKey('mira'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: null },
      { id: 'childhood_friend', nameKey: npcNameKey('childhood_friend'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'childhood_rival', nameKey: npcNameKey('childhood_rival'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'childhood_younger', nameKey: npcNameKey('childhood_younger'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'neighborhood_merchant', nameKey: npcNameKey('neighborhood_merchant'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'rohan', nameKey: npcNameKey('rohan'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian' },
      { id: 'ari', nameKey: npcNameKey('ari'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian' },
      { id: 'owen', nameKey: npcNameKey('owen'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian' },
      { id: 'active_recruit_knot_runner', nameKey: npcNameKey('active_recruit_knot_runner'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'active_recruit_notice_carver', nameKey: npcNameKey('active_recruit_notice_carver'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'active_recruit_wake_keeper', nameKey: npcNameKey('active_recruit_wake_keeper'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'active_recruit_lot_runner', nameKey: npcNameKey('active_recruit_lot_runner'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'civilian' },
      { id: 'active_rival_revolutionary_01_rival', nameKey: npcNameKey('active_rival_revolutionary_01_rival'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'revolutionary' },
      { id: 'active_rival_marine_01_peer_officer', nameKey: npcNameKey('active_rival_marine_01_peer_officer'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'marine' },
      { id: 'active_rival_pirate_01_captain', nameKey: npcNameKey('active_rival_pirate_01_captain'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: 'pirate' },
      { id: 'player_parent_1', nameKey: npcNameKey('player_parent_1'), sex: 'male', familyRole: 'father', namePoolId: 'childhood_male', raceId: null, originSeaId: null, affiliationId: null },
      { id: 'player_parent_2', nameKey: npcNameKey('player_parent_2'), sex: 'female', familyRole: 'mother', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: null },
    ],
    majorNarrativeTracks: [
      ...
      })),
      {
        ...
        eligibility: { type: 'careerAffiliationIs' as const, affiliationId: 'civilian' },
        chapters: [
          { id: 'active_01', phase: 'active' as const, dueAgeMonths: 192 },
          { id: 'active_02', phase: 'active' as const, dueAgeMonths: 216 },
          { id: 'active_03', phase: 'active' as const, dueAgeMonths: 240 },
          { id: 'active_04', phase: 'active' as const, dueAgeMonths: 264 },
          { id: 'active_05', phase: 'active' as const, dueAgeMonths: 288 },
          { id: 'active_06', phase: 'active' as const, dueAgeMonths: 312 },
          { id: 'active_07', phase: 'active' as const, dueAgeMonths: 336 },
          { id: 'active_08', phase: 'active' as const, dueAgeMonths: 360 },
          { id: 'active_09', phase: 'active' as const, dueAgeMonths: 384 },
          { id: 'active_10', phase: 'active' as const, dueAgeMonths: 408 },
        ],
      },
      {
        id: 'career_marine',
