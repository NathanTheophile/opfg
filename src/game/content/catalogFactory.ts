...
export function createContentCatalog(events: EventDefinition[]): ContentCatalog {
  return {
    ...
    npcs: [
      { id: 'mira', nameKey: npcNameKey('mira'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: null, affiliationId: null, crewRoleId: 'navigator', initialStats: defaultNpcStats() },
      ...
      { id: 'rohan', nameKey: npcNameKey('rohan'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian', crewRoleId: 'cook', initialStats: defaultNpcStats() },
      { id: 'ari', nameKey: npcNameKey('ari'), sex: 'female', namePoolId: 'childhood_female', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian', crewRoleId: 'medic', initialStats: defaultNpcStats() },
      { id: 'owen', nameKey: npcNameKey('owen'), sex: 'male', namePoolId: 'childhood_male', raceId: null, originSeaId: 'east_blue', affiliationId: 'civilian', crewRoleId: 'shipwright', initialStats: defaultNpcStats() },
