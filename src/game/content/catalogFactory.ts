...
export function createContentCatalog(events: EventDefinition[]): ContentCatalog {
  return {
    ...
    items: [
      ...
      { id: 'family_marine_field_compass', nameKey: itemNameKey('family_marine_field_compass'), category: 'equipment', stackLimit: 1, market: null, unique: true, modifiers: { navigation: 1 } },
      ...
      { id: 'civilian_workshop_toolkit', nameKey: itemNameKey('civilian_workshop_toolkit'), category: 'equipment', stackLimit: 1, market: null, unique: true, modifiers: { intelligence: 1 } },
      { id: 'civilian_workshop_cat', nameKey: itemNameKey('civilian_workshop_cat'), category: 'item', stackLimit: 1, market: null, unique: true, companion: true, modifiers: { observation: 1 } },
      { id: 'family_pirate_black_flag_patch', nameKey: itemNameKey('family_pirate_black_flag_patch'), category: 'item', stackLimit: 1, market: null, unique: true },
      ...
      { id: 'family_pirate_salt_chart', nameKey: itemNameKey('family_pirate_salt_chart'), category: 'item', stackLimit: 1, market: null, unique: true },
      ...
      { id: 'pirate_safe_harbor_gull', nameKey: itemNameKey('pirate_safe_harbor_gull'), category: 'item', stackLimit: 1, market: null, unique: true, companion: true, modifiers: { navigation: 1 } },
      { id: 'family_royal_unmarked_travel_boots', nameKey: itemNameKey('family_royal_unmarked_travel_boots'), category: 'equipment', stackLimit: 1, market: null, unique: true, modifiers: { agility: 1 } },
      { id: 'royal_palace_hound', nameKey: itemNameKey('royal_palace_hound'), category: 'item', stackLimit: 1, market: null, unique: true, companion: true, modifiers: { morale: 1 } },
