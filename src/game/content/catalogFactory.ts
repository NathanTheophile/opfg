...
import { CAREER_ENDING_IDS } from './careerEndings';
...
export function createContentCatalog(events: EventDefinition[]): ContentCatalog {
  return {
    ...
    endings: ['career_complete', 'stranded', 'lost_at_sea', 'v1_career_horizon', ...CAREER_ENDING_IDS].map((id) => ({ id, nameKey: endingNameKey(id), descriptionKey: endingDescriptionKey(id) })),
    familyStructures: [
    ...
    devilFruits,
    ships: [
      { id: 'dinghy', nameKey: 'ship.dinghy.name', maxHealth: 54, crewCapacity: 1, cargoSlots: 1, priceBerries: 5000 },
      { id: 'sloop', nameKey: 'ship.sloop.name', maxHealth: 90, crewCapacity: 3, cargoSlots: 2, priceBerries: 25000 },
      { id: 'caravel', nameKey: 'ship.caravel.name', maxHealth: 114, crewCapacity: 5, cargoSlots: 4, priceBerries: 150000 },
      { id: 'brig', nameKey: 'ship.brig.name', maxHealth: 150, crewCapacity: 7, cargoSlots: 3, priceBerries: 75000 },
      { id: 'merchant_ship', nameKey: 'ship.merchant_ship.name', maxHealth: 126, crewCapacity: 5, cargoSlots: 8, priceBerries: 300000 },
      { id: 'galleon', nameKey: 'ship.galleon.name', maxHealth: 195, crewCapacity: 9, cargoSlots: 6, priceBerries: 400000 },
    ],
    crewRoles: [
