...
const STAT_KEYS: Record<keyof GameState['player']['stats'], string> = { health: 'stat.health', morale: 'stat.morale', strength: 'stat.strength', agility: 'stat.agility', observation: 'stat.observation', intelligence: 'stat.intelligence', navigation: 'stat.navigation', charisma: 'stat.charisma', luck: 'stat.luck', awakening: 'stat.awakening' };
