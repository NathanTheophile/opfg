export function mountTavernBackground(app: HTMLDivElement): () => void {
  ...
  function drawAnimatedFlame(
    ...
    const bodyHalfWidth = 10.2 * widthFactor * 0.98;
  ...
  function drawEffects(
    ...
    for (const particle of dust) {
      ...
      const lanternInfluenceX = (renderX / currentScene.artWidth - currentScene.lanternGlowU) / 0.48;
      const lanternInfluenceY = (renderY / currentScene.artHeight - currentScene.lanternGlowV) / 0.55;
