...
export const UI_TUNER_DEFINITIONS: UITunerDefinition[] = [
  ...
  range('hudPanelMinHeight', 'HUD haut — hauteur minimale', 'hud', '--ui-hud-panel-min-height', 96, 72, 190, 1, 'px'),
  range('hudIdentityPx', 'HUD central — padding X', 'hud', '--ui-hud-identity-padding-x', 14, 0, 30, 1, 'px'),
  range('hudIdentityPy', 'HUD central — padding Y', 'hud', '--ui-hud-identity-padding-y', 0.32, 0, 1.5, 0.01, 'rem'),
  range('hudHeaderMinHeight', 'Headers HUD — hauteur min', 'hud', '--ui-hud-header-min-height', 3, 1.5, 4, 0.05, 'rem'),
  range('hudHeaderIconColumn', 'Headers HUD — colonne icône', 'hud', '--ui-hud-header-icon-column', 2.05, 1, 3, 0.05, 'rem'),
  range('hudHeaderColumnGap', 'Headers HUD — gap icône / contenu', 'hud', '--ui-hud-header-column-gap', 0.35, 0, 1.25, 0.05, 'rem'),
  range('hudHeaderPaddingTop', 'Headers HUD — padding haut', 'hud', '--ui-hud-header-padding-top', 0.3, 0, 1.5, 0.01, 'rem'),
  range('hudHeaderPaddingRight', 'Headers HUD — padding droite', 'hud', '--ui-hud-header-padding-right', 0.78, 0, 2, 0.01, 'rem'),
  range('hudHeaderPaddingBottom', 'Headers HUD — padding bas', 'hud', '--ui-hud-header-padding-bottom', 0.12, 0, 1.5, 0.01, 'rem'),
  ...
  range('hudAdventureGap', 'HUD haut ↔ Aventure — gap vertical', 'hud', '--ui-hud-adventure-gap', 1, 0, 4, 0.05, 'rem'),
  range('adventureRailGap', 'Event ↔ Stats / Crew — gap horizontal', 'hud', '--ui-adventure-rail-gap', 1, 0, 4, 0.05, 'rem'),
  ...
  range('eventBodyPt', 'Parchemin Event — padding haut', 'event', '--ui-event-body-pt', 0, 0, 40, 0.5, 'px'),
  range('eventBodyPb', 'Parchemin Event — padding bas', 'event', '--ui-event-body-pb', 0, 0, 40, 0.5, 'px'),
  ...
  range('outcomeBodyMarginTop', 'Parchemin Outcome — espace avant', 'outcome', '--ui-outcome-body-margin-top', 0.38, 0, 2, 0.01, 'rem'),
  range('outcomeBodyPaddingTop', 'Parchemin Outcome — padding haut', 'outcome', '--ui-outcome-body-padding-top', 0.52, 0, 2, 0.01, 'rem'),
  range('outcomeBodyPaddingBottom', 'Parchemin Outcome — padding bas', 'outcome', '--ui-outcome-body-padding-bottom', 0.34, 0, 2, 0.01, 'rem'),
