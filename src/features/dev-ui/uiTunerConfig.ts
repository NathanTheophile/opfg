...
export const UI_TUNER_DEFINITIONS: UITunerDefinition[] = [
  ...
  range('hudIdentityPx', 'HUD central — padding X', 'hud', '--ui-hud-identity-padding-x', 30, 0, 30, 1, 'px'),
  ...
  range('hudNameSize', 'Nom joueur', 'hud', '--ui-hud-name-size', 13.5, 12, 32, 0.5, 'px'),
  range('hudNameTranslateY', 'Nom joueur — translate Y', 'hud', '--ui-hud-name-translate-y', -8.5, -24, 24, 0.25, 'px'),
  range('hudTitleSize', 'Titre / affiliation', 'hud', '--ui-hud-title-size', 8.7, 7, 18, 0.1, 'px'),
  range('hudTitleTranslateY', 'Titre / affiliation — translate Y', 'hud', '--ui-hud-title-translate-y', -5, -24, 24, 0.25, 'px'),
  ...
  range('choicePy', 'Choice Y', 'event', '--ui-choice-py', 5, 2, 28, 0.1, 'px'),
  ...
  range('choiceDicePaddingX', 'Jet — padding X', 'event', '--ui-choice-dice-padding-x', 0.5, 0, 2, 0.025, 'rem'),
  range('choiceDicePaddingY', 'Jet — padding Y', 'event', '--ui-choice-dice-padding-y', 0.25, 0, 1, 0.025, 'rem'),
  ...
  range('statsExpandedWidth', 'Rail ouvert', 'stats', '--ui-stats-expanded-width', 200, 150, 340, 1, 'px'),
  ...
  range('crewExpandedWidth', 'Crew ouvert', 'crew', '--ui-crew-expanded-width', 190, 80, 420, 1, 'px'),
