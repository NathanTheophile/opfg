  ...
  summarize(samples) {
    ...
    return {
      ...
      ships: {
        ...
        firstSloopAgeMonths: stats(samples.flatMap(({ firstSloopAgeMonths }) => firstSloopAgeMonths === null ? [] : [firstSloopAgeMonths])),
        firstSloopPurchaseOpportunityAgeMonths: stats(samples.flatMap(({ firstSloopPurchaseOpportunityAgeMonths }) => firstSloopPurchaseOpportunityAgeMonths === null ? [] : [firstSloopPurchaseOpportunityAgeMonths])),
        sloopPurchaseOpportunitiesBefore20: samples.reduce((sum, sample) => sum + sample.sloopPurchaseOpportunitiesBefore20, 0),
        runsWithSloopOpportunityBefore20: samples.filter(({ firstSloopPurchaseOpportunityAgeMonths }) => firstSloopPurchaseOpportunityAgeMonths !== null && firstSloopPurchaseOpportunityAgeMonths < 240).length,
