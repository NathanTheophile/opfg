...
describe('GameState v19', () => {
  it('creates an isolated JSON-compatible origin state', () => {
    ...
    expect(first).toMatchObject({ version: 19, careerPhase: 'origins', ageMonths: 0, slotInMonth: 0, player: { career: { affiliationId: 'civilian', reputation: 0, bounty: 0, rankId: null, titleId: null } }, ship: null, pendingShip: null, maritimeEmergency: null, isLeader: true, passengerNpcIds: [], berries: 0, endingId: null });
