...
const catalog = (events: EventDefinition[]): ContentCatalog => ({ schemaVersion: 2, races: [], seas: [], affiliations: [], familyStructures: [], socialClasses: [], locations: [{ id: 'starter_port', seaId: null, blocksScheduledEvents: false, allowsShipSale: true }], traits: [], items: [], ships: [{ id: 'starter_sloop', nameKey: 'x', maxHealth: 30, crewCapacity: 3, cargoSlots: 2 }], crewRoles: [], npcs: [], events });
